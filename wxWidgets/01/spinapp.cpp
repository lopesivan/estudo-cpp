...
SpinFrame::SpinFrame()
    : wxFrame(NULL, wxID_ANY, "Aplicativo com Botão Giratório"), m_counter(0)
{
    // Criar menu
    ...
    // Título
    wxStaticText* title = new wxStaticText(panel, wxID_ANY, "Contador com Botão Giratório");
    ...
    // Seção do SpinButton
    wxStaticBoxSizer* spinButtonBox = new wxStaticBoxSizer(wxVERTICAL, panel, "Botão Giratório");
    ...
    // Botão giratório
    m_spinButton = new wxSpinButton(panel, ID_SpinButton, wxDefaultPosition, wxDefaultSize, wxSP_VERTICAL);
    ...
    wxStaticBoxSizer* spinCtrlBox = new wxStaticBoxSizer(wxVERTICAL, panel, "Controle de Spin com Texto");
    
    wxBoxSizer* spinCtrlSizer = new wxBoxSizer(wxHORIZONTAL);
    
    wxStaticText* spinCtrlLabel = new wxStaticText(panel, wxID_ANY, "Valor:");
    m_spinCtrl = new wxSpinCtrl(panel, ID_SpinCtrl, "0", wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, -50, 50, 0);
    ...
    wxStaticText* instructions = new wxStaticText(panel, wxID_ANY, 
        "Use as setas do botão giratório para incrementar/decrementar o contador.\n"
        "O SpinCtrl permite digitar o valor diretamente ou usar as setas.");
...
void SpinFrame::OnExit(wxCommandEvent& event)
{
    Close(true);
}
...
{
    wxMessageBox("Aplicativo demonstrando o uso de controles giratórios em wxWidgets",
