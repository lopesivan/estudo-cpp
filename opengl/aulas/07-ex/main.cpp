...
// ────────────────────────────────────────────────────────────────
static const GLfloat WORLD_W = 200.0f; // largura lógica
static const GLfloat WORLD_H = 150.0f; // altura  lógica
...
void display()
{
    ...
    // Circulo de centro (c_x , c_y) e raio r
    // -----------------------------------------------------------------
    c_x = 100.0f;   // centro X  (metade de WORLD_W)
    c_y =  75.0f;   // centro Y  (metade de WORLD_H)
