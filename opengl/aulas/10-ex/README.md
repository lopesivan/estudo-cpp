...
* `(0,0)` é o canto **inferior-esquerdo** porque o `gluOrtho2D` foi definido como `gluOrtho2D(0, WORLD_W, 0, WORLD_H)`. Assim, o eixo **y cresce para cima**.
...
Quer **ambas** as diagonais?  Basta repetir o par de vértices:
